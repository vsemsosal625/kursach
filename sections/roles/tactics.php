<?php
// sections/roles/tactics.php — раздел «Функциональные роли игроков» (список)
            ...
            <div class="mechanics-category-block">
                ...
                <div class="mechanics-grid">
                    <?php foreach ($grouped[$cat] as $t): ?>
                        <a href="<?= BASE_URL ?>/sections/roles/tactic.php?id=<?= $t['id_game_mechanic'] ?>" class="mechanic-card">
