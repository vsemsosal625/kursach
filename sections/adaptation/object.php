<?php
// sections/adaptation/object.php — детальная карточка раздела «Адаптация и расчет времени»
...
$stmt->execute([$id]);
$object = $stmt->fetch();
if (!$object) { header('Location: ' . BASE_URL . '/sections/adaptation/objects.php'); exit; }
...
if ($from === 'favorites') {
    ...
    $backLink = BASE_URL . '/sections/adaptation/objects.php';
