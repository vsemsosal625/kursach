...
$sql = "SELECT f.*, u.login AS u_login, u.name AS u_name, u.surname AS u_surname FROM feedback f LEFT JOIN `user` u ON f.user_id = u.id_user";
$params = [];
...
.fb-meta { color:#8f98a0; font-size:13px; margin-bottom:12px; display:flex; flex-wrap:wrap; gap:14px; }
...
<div class="fb-wrap">
    ...
    ?>
        <div class="fb-card">
            ...
            <form method="post" onsubmit="return confirm('Удалить это обращение безвозвратно?');" style="margin-top:10px;">
