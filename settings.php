...
<head>
    ...
    <title>Оптимальные настройки | Игровой справочник</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .click-hint { color: #8b5cf6; font-size: 13px; margin-top: 12px; text-align: center; font-weight: 600; }
...
<body>
    ...
    <div class="main-wrapper">
        <div class="page-header">
            <h1 class="page-title">⚙️ Оптимальные настройки</h1>
            <div class="controls">
                <div class="filter-group">
                    <span class="filter-label">Категория:</span>
                    <div class="filter-dropdown">
                        <button class="filter-btn" onclick="toggleFilter()">
                            <span id="currentFilterText"><?= !empty($categoryFilter) ? ($categoryEmojis[$categoryFilter] ?? '⚙️') . ' ' . $categoryFilter : '🌐 Все' ?></span>
                ...
                <div class="search-box">
                    ...
                    <input type="text" class="search-input" id="searchInput" placeholder="Поиск настроек..." value="<?= htmlspecialchars($searchQuery) ?>">
                </div>
            </div>
        </div>
        
        <?php if (empty($groupedSettings) || (count($groupedSettings) == 1 && empty(reset($groupedSettings)))): ?>
        ...
        <?php else: ?>
            <?php 
            $displayCategories = !empty($categoryFilter) ? [$categoryFilter => $groupedSettings[$categoryFilter]] : $groupedSettings;
            ?>
            <div class="settings-grid">
                <?php foreach ($displayCategories as $category => $items): 
                ...
                ?>
                    <div class="setting-category">
                        ...
                        <a href="setting_detail.php?id=<?= $item['id_game_mechanic'] ?>" class="setting-card">
