...
if ($from === 'favorites') {
    ...
    $backText = 'Назад к списку объектов';
}

$pageTitle = htmlspecialchars($object['title']);
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-btn { display: inline-flex; align-items: center; gap: 8px; color: #6ee7b7; text-decoration: none; margin-bottom: 20px; font-size: 14px; transition: color 0.2s; }
        ...
        .object-detail .meta { color: #8f98a0; font-size: 14px; margin-bottom: 25px; padding-bottom: 20px; border-bottom: 1px solid #36414d; }
        .object-detail .category-badge { display: inline-block; background: rgba(16,185,129,0.2); color: #6ee7b7; padding: 6px 16px; border-radius: 20px; font-size: 13px; font-weight: 600; margin-right: 15px; }
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!-- КНОПКА ИЗБРАННОГО -->
        <button id="favBtn" class="fav-btn" onclick="toggleFavorite('object', <?= $id ?>)">
        ...
        <div class="object-detail">
            ...
            <div class="meta">
                <span class="category-badge">
                    <i class="fas fa-clock me-2"></i><?= htmlspecialchars($object['category']) ?>
                </span>
                <span><i class="far fa-calendar"></i> <?= date('d.m.Y', strtotime($object['created_date'])) ?></span>
            </div>
