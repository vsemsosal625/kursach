<?php
// sections/synergy/synergy.php — раздел «Синергия героев на линии» (список)
        ...
        <div class="category-section">
            ...
            <div class="synergy-grid">
                <?php foreach ($laneSynergies as $syn): ?>
                    <a href="<?= BASE_URL ?>/sections/synergy/synergy_detail.php?id=<?= $syn['id_game_mechanic'] ?>" class="synergy-card">
